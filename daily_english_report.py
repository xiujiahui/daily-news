...
def get_chinese_news():
    ...
    prompt = f"请提供{yesterday_chinese}（昨天）当天的3条最新真实中文新闻，必须严格遵循以下要求：\n\n1. 时间要求：\n   - 新闻必须是{yesterday_chinese}当天发生并发布的真实事件，禁止使用过期新闻或未发生事件的超前报道；\n   - 新闻必须是过去7天内的最新内容，优先选择{yesterday_chinese}当天的新闻；\n2. 内容要求：\n   - 科技动态（如AI、互联网、科技产品等）\n   - 国际政治局势（如国际关系、重要会议等）\n   - 国内外娱乐大事（需同时包含国内和国外的娱乐新闻）\n3. 来源要求：确保新闻来源权威可靠，如新华网、人民网、央视新闻、环球网等；\n4. 格式要求：必须严格按照以下格式输出，不要添加任何其他内容：\n\n1. 标题：[新闻标题]\n   摘要：[新闻摘要，50字以内]\n   来源：[新闻来源]\n   链接：[新闻链接]\n\n2. 标题：[新闻标题]\n   摘要：[新闻摘要，50字以内]\n   来源：[新闻来源]\n   链接：[新闻链接]\n\n3. 标题：[新闻标题]\n   摘要：[新闻摘要，50字以内]\n   来源：[新闻来源]\n   链接：[新闻链接]\n\n请确保所有新闻真实可信，时间准确，只返回符合条件的新闻，不要添加任何其他解释或说明。"
